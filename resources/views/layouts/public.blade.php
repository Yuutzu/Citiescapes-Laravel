...
<body class="bg-paper-100 text-brand-950">
    {{-- Public top nav --}}
    <header class="bg-paper-50/95 backdrop-blur-sm shadow-sm border-b border-paper-300/60 sticky top-0 z-30">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="flex h-16 items-center justify-between">
                <a href="/" class="flex items-center gap-3">
                    <img src="/storage/building/logo.png" alt="Citiescapes" class="h-9 w-9 rounded-lg object-cover ring-1 ring-brand-200">
                    <div class="leading-tight">
                        <span class="block font-serif font-bold text-brand-900 text-lg">Citiescapes</span>
                        <span class="block text-[10px] uppercase tracking-[0.18em] text-brand-700/80">Apartment Rental</span>
                    </div>
                </a>
