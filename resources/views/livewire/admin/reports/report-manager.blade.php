            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-4 py-3 text-right space-x-1">
                        <button wire:click="restore({{ $a->id }})" wire:confirm="Restore this record?" class="text-xs text-green-600 hover:text-green-800">Restore</button>
                        <button wire:click="permanentDelete({{ $a->id }})" wire:confirm="PERMANENTLY delete? Cannot be undone." class="text-xs text-red-500 hover:text-red-700">Delete</button>
                    </td>
                </tr>
                @endforeach
            </tbody>
