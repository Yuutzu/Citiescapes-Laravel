    ...
    <form wire:submit="save" class="max-w-xl space-y-4">
        <div class="card space-y-4">
            ...
            <div><label class="form-label">Full Name</label><input wire:model="full_name"
                    class="form-input">@error('full_name')<p class="text-xs text-red-600 mt-1">{{ $message }}</p>
                    @enderror</div>
            <div><label class="form-label">Email</label><input value="{{ $email }}" class="form-input bg-gray-50"
                    disabled>
