...
class Contract extends Model
{
    ...
    protected $fillable = [
        ...
        'deposit_applied_amount', 'deposit_applied_at',
        ...
        'scan_view_status', 'scan_view_requested_at', 'scan_view_decided_at',
        'scan_view_decided_by', 'scan_view_decision_note',
    ...
    protected function casts(): array
    {
        return [
            ...
            'scan_view_requested_at'  => 'datetime',
            'scan_view_decided_at'    => 'datetime',
