<div>
    ...
    <form wire:submit="save" class="max-w-xl space-y-4">
        <div class="card space-y-4">
            <div><label class="form-label">Full Name</label><input wire:model="full_name" class="form-input"><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['full_name'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?></div>
            <div><label class="form-label">Email</label><input value="<?php echo e($email); ?>" class="form-input bg-gray-50" disabled><p class="text-xs text-gray-400 mt-1">Contact the GM to change your email.</p></div>
...
<?php /**PATH C:\laragon\www\citiescapes\resources\views/livewire/tenant/profile.blade.php ENDPATH**/ ?>