            ...
            <tbody class="divide-y divide-gray-100">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $contracts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3 text-xs text-gray-500"><?php echo e($c->start_date->format('M d, Y')); ?> —
                            <?php echo e($c->end_date->format('M d, Y')); ?></td>
                        <td class="px-4 py-3">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($c->status === 'active'): ?>
                                ...
                                <div class="w-16 bg-gray-200 rounded-full h-1.5 mt-1">
                                    <div class="bg-brand-600 h-1.5 rounded-full" style="width: <?php echo e($c->progress_percent); ?>%">
                                    </div>
                                </div>
                            <?php else: ?>
                        ...
                        <td class="px-4 py-3"><span
                                class="badge <?php echo e(match ($c->status) { 'draft' => 'bg-gray-100 text-gray-600', 'active' => 'bg-green-100 text-green-800', 'expired' => 'bg-gray-100 text-gray-600', 'terminated' => 'bg-red-100 text-red-800', default => 'bg-gray-100 text-gray-600'}); ?>"><?php echo e(ucfirst($c->status)); ?></span>
                        </td>
                        <td class="px-4 py-3">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($c->scan_file_path): ?>
                                <a href="<?php echo e(asset('storage/' . $c->scan_file_path)); ?>" target="_blank"
                        ...
                        <td class="px-4 py-3 text-right space-x-1">
                            <button wire:click="edit(<?php echo e($c->id); ?>)"
                                class="text-xs text-brand-600 hover:text-brand-800">Edit</button>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($c->status === 'draft'): ?>
                                <button wire:click="activate(<?php echo e($c->id); ?>)"
                                    class="text-xs text-green-600 hover:text-green-800 font-medium">Activate</button>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($c->status === 'active'): ?>
                                <button wire:click="renew(<?php echo e($c->id); ?>)"
                                    class="text-xs text-green-600 hover:text-green-800">Renew</button>
                                <button wire:click="openTerminate(<?php echo e($c->id); ?>)"
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div>
                            ...
                            <select wire:model="room_id" class="form-input">
                                <option value="">— Select —</option>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $rooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><option value="<?php echo e($r->id); ?>"><?php echo e($r->room_number); ?>

                                (<?php echo e(ucfirst($r->room_type)); ?>)</option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </select>
                        </div>
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-xl w-full max-w-md mx-4 p-6">
                ...
                <form wire:submit="terminate" class="space-y-4">
                    <div><label class="form-label">Reason *</label><textarea wire:model="terminateReason" rows="3"
                            class="form-input"></textarea><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['terminateReason'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?></div>
    ...
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</div><?php /**PATH C:\laragon\www\citiescapes\resources\views/livewire/admin/contracts/contract-manager.blade.php ENDPATH**/ ?>