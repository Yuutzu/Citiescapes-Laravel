        ...
        <div class="card">
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-500"><?php echo e($inq->contact_number); ?> <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($inq->email): ?> &bull; <?php echo e($inq->email); ?> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?></p>
                    <p class="text-xs text-gray-400 mt-0.5">Preferred: <?php echo e(ucfirst($inq->preferred_room_type)); ?> &bull; <?php echo e($inq->created_at->format('M d, Y h:i A')); ?></p>
                </div>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($inq->gm_notes): ?>
                <p class="mt-2 text-sm text-brand-700 bg-brand-50 rounded-lg p-3"><span class="font-medium">GM Notes:</span> <?php echo e($inq->gm_notes); ?></p>
