...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
    <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="background: #f5f7fa; padding: 15px; border-radius: 8px; margin: 20px 0;">
            <p style="margin: 5px 0;"><strong>Email:</strong> <?php echo e($email); ?></p>
            <p style="margin: 5px 0;"><strong>Temporary Password:</strong> <code style="font-size: 18px; color: #d97706;"><?php echo e($tempPassword); ?></code></p>
        </div>
...
<?php /**PATH C:\laragon\www\citiescapes\resources\views/emails/temp-password.blade.php ENDPATH**/ ?>