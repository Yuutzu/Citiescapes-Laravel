            ...
            <div class="card">
                <div class="flex items-start justify-between mb-3">
                    <div>
                        <p class="font-semibold text-gray-900">
                            <?php echo e($bill->type === 'initial' ? 'Initial Fees' : $bill->billing_period); ?></p>
                        <p class="text-xs text-gray-500">Room <?php echo e($bill->room->room_number); ?> &bull; Due
                            <?php echo e($bill->due_date->format('M d, Y')); ?></p>
                    </div>
                    <span
                ...
                <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 text-sm">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($bill->type === 'initial'): ?>
                        <div><span class="text-gray-500">Deposit:</span><br><span
                                class="font-medium">₱<?php echo e(number_format($bill->deposit_amount, 2)); ?></span></div>
                        <div><span class="text-gray-500">First Month:</span><br><span
                                class="font-medium">₱<?php echo e(number_format($bill->base_rent, 2)); ?></span></div>
                        <div><span class="text-gray-500">Key Fee:</span><br><span
                                class="font-medium">₱<?php echo e(number_format($bill->room_key_fee, 2)); ?></span></div>
                    <?php else: ?>
                        ...
                        <div class="col-span-2 sm:col-span-3">
                            ...
                            <div class="grid grid-cols-2 sm:grid-cols-4 gap-2">
                                <div class="bg-gray-50 rounded p-2 text-center">
                                    ...
                                    <p class="font-medium text-gray-900">₱<?php echo e(number_format($bill->electricity ?? 0, 2)); ?></p>
                                </div>
                                <div class="bg-gray-50 rounded p-2 text-center">
                                    <p class="text-xs text-gray-400">Water</p>
                                    <p class="font-medium text-gray-900">₱<?php echo e(number_format($bill->water ?? 0, 2)); ?></p>
                                </div>
                                <div class="bg-gray-50 rounded p-2 text-center">
                                    <p class="text-xs text-gray-400">WiFi</p>
                                    <p class="font-medium text-gray-900">₱<?php echo e(number_format($bill->wifi ?? 0, 2)); ?></p>
                                </div>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($bill->extras ?? 0) > 0): ?>
                                <div class="bg-gray-50 rounded p-2 text-center">
                                    <p class="text-xs text-gray-400">Extras</p>
                                    <p class="font-medium text-gray-900">₱<?php echo e(number_format($bill->extras, 2)); ?></p>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($bill->extras_note): ?>
                                        <p class="text-xs text-gray-400 mt-0.5"><?php echo e($bill->extras_note); ?></p>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($bill->penalty_amount > 0): ?>
                            <div><span class="text-gray-500">Penalty:</span><br><span
                                    class="font-medium text-red-600">₱<?php echo e(number_format($bill->penalty_amount, 2)); ?></span></div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <div><span class="text-gray-500">Total:</span><br><span
                            class="font-bold text-lg text-gray-900">₱<?php echo e(number_format($bill->total_amount, 2)); ?></span>
                    </div>
                </div>
                    ...
                    <div class="mt-3 border-t border-gray-100 pt-3">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $bill->payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center justify-between text-sm py-1">
                                <span class="text-gray-600">₱<?php echo e(number_format($p->amount, 2)); ?> via
                                    <?php echo e(ucfirst(str_replace('_', ' ', $p->payment_method))); ?></span>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($bill->status !== 'paid' && $bill->days_overdue > 0): ?>
                    <div class="mt-3 rounded-lg bg-red-50 p-3 text-sm text-red-700">
                        This bill is <?php echo e($bill->days_overdue); ?> day(s) overdue. Please settle your payment with the General
...
</div><?php /**PATH C:\laragon\www\citiescapes\resources\views/livewire/tenant/billing-view.blade.php ENDPATH**/ ?>