...
<body>
    <div class="wrapper">
        ...
        <div class="body">
            ...
            <h2 class="announcement-title"><?php echo e($title); ?></h2>
            <p class="announcement-body"><?php echo e($body); ?></p>
            <hr class="divider">
...
<?php /**PATH C:\laragon\www\citiescapes\resources\views/emails/announcement.blade.php ENDPATH**/ ?>