                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $rooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3"><span
                                class="badge <?php echo e($room->status_badge); ?>"><?php echo e(str_replace('_', ' ', ucfirst($room->status))); ?></span>
                        </td>
                        ...
                        <td class="px-4 py-3 text-right">
                            <div class="flex items-center justify-end gap-1" x-data="{ open: false }">
                                <button wire:click="edit(<?php echo e($room->id); ?>)"
                                ...
                                <div class="relative">
                                    ...
                                    <div x-show="open" @click.away="open = false"
                                        ...
                                        <button wire:click="updateStatus(<?php echo e($room->id); ?>, 'available')" @click="open=false"
                                            class="block w-full text-left px-3 py-1.5 text-xs hover:bg-gray-50 text-green-700">Available</button>
                                        <button wire:click="updateStatus(<?php echo e($room->id); ?>, 'occupied')" @click="open=false"
                                            class="block w-full text-left px-3 py-1.5 text-xs hover:bg-gray-50 text-blue-700">Occupied</button>
                                        <button wire:click="updateStatus(<?php echo e($room->id); ?>, 'under_maintenance')"
                                            @click="open=false"
                                            class="block w-full text-left px-3 py-1.5 text-xs hover:bg-gray-50 text-amber-700">Maintenance</button>
                                    </div>
                                </div>
                                <button wire:click="archiveRoom(<?php echo e($room->id); ?>)" wire:confirm="Archive this room record?"
                        ...
                        <div class="flex flex-wrap gap-2 mt-1">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $this->availableAmenities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $amenity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <label class="inline-flex items-center gap-1.5 text-sm cursor-pointer">
                                    <input type="checkbox" wire:model="amenitiesInput" value="<?php echo e($amenity); ?>"
...
</div><?php /**PATH C:\laragon\www\citiescapes\resources\views/livewire/admin/rooms/room-manager.blade.php ENDPATH**/ ?>