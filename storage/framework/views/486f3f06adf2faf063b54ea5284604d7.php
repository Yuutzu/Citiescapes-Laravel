...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($recipientType === 'specific'): ?>
                        <div>
                            ...
                            <select wire:model="recipientId" class="form-input">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $tenants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tenant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($tenant->id); ?>"><?php echo e($tenant->full_name); ?> (<?php echo e($tenant->email); ?>)</option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </select>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['recipientId'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="mt-1 text-sm text-red-600"><?php echo e($message); ?></p> <?php unset($message);
            ...
            <div class="bg-white rounded-xl shadow-xl w-full max-w-xl">
                ...
                <div class="px-6 py-5 space-y-4">
                    <div>
                        ...
                        <p class="font-semibold text-gray-900 text-lg"><?php echo e($viewing->title); ?></p>
                    </div>
                    <div class="flex flex-wrap gap-2">
                        <span class="badge <?php echo e($viewing->recipient_type === 'all' ? 'bg-indigo-100 text-indigo-800' : 'bg-purple-100 text-purple-800'); ?>">
                            <?php echo e($viewing->recipient_label); ?>

                        </span>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($viewing->email_sent): ?>
                    ...
                    <div class="pt-2 border-t border-gray-100 text-xs text-gray-400">
                        Sent by <span class="font-medium text-gray-600"><?php echo e($viewing->sentBy?->full_name); ?></span>
                        on <?php echo e($viewing->created_at->format('M d, Y g:i A')); ?>
    ...
    <div class="card overflow-hidden p-0">
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="divide-y divide-gray-100 bg-white">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $announcements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ann): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gray-50">
                        <td class="px-6 py-4">
                            <p class="font-medium text-gray-900 text-sm"><?php echo e($ann->title); ?></p>
                            <p class="text-xs text-gray-400 mt-0.5 line-clamp-1"><?php echo e($ann->body); ?></p>
                        </td>
                        <td class="px-6 py-4">
                            <span class="badge <?php echo e($ann->recipient_type === 'all' ? 'bg-indigo-100 text-indigo-800' : 'bg-purple-100 text-purple-800'); ?>">
                                <?php echo e($ann->recipient_label); ?>

                            </span>
                        </td>
                        <td class="px-6 py-4">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ann->email_sent): ?>
                                <span class="badge bg-green-100 text-green-800">Sent</span>
                            <?php else: ?>
                                <span class="badge bg-gray-100 text-gray-500">No</span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </td>
                        <td class="px-6 py-4 text-sm text-gray-500"><?php echo e($ann->created_at->diffForHumans()); ?></td>
                        <td class="px-6 py-4 text-right">
                            <button wire:click="$set('viewingId', <?php echo e($ann->id); ?>)" class="text-sm text-brand-700 hover:text-brand-900 font-medium">View</button>
                        </td>
                    </tr>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($announcements->hasPages()): ?>
            <div class="px-6 py-3 border-t border-gray-200"><?php echo e($announcements->links()); ?></div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </div>
</div>
<?php /**PATH C:\laragon\www\citiescapes\resources\views/livewire/admin/communications/announcement-manager.blade.php ENDPATH**/ ?>